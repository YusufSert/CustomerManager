...
class VMFSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class VMFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VMFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VMFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VMFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VMFDateTimeConverter dateTimeConverter = new VMFStandardDateTimeConverter();

    public VMFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VMFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VMFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VMFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VMFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VMFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
