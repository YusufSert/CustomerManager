...
public class VMFKPSPublicSoap
{
    ...
    public VMFKPSPublicSoap(){}

    public VMFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VMFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VMFExtendedSoapSerializationEnvelope envelope= new VMFExtendedSoapSerializationEnvelope(VMFExtendedSoapSerializationEnvelope.VER11);
